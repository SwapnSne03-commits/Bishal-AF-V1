...
USERNAME = environ.get('USERNAME', "https://telegram.me/yours_swap_bot")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002900228022'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/graduate_request_pro')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002533229703 -1002633335930 -1002533695302').split()]
...
START_IMG = environ.get('START_IMG', 'https://graph.org/file/56b5deb73f3b132e2bb73.jpg https://graph.org/file/5303692652d91d52180c2.jpg')
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002900228022'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','1002900228022'))
...
REF_PREMIUM = 30
PREMIUM_POINT = 1500
auth_channel = environ.get('AUTH_CHANNEL', '-1003878655942')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1001816697837'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002612579654')
